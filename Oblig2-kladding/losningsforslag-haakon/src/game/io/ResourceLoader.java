...
public interface ResourceLoader {
	...
	/**
	 * Henter ut alle highscores for et gitt brett.
	 * @param levelName navnet på brettet du vil ha highscores fra
	 * @return En liste i sortert rekkefølge over alle highscores fra det brettet. Hvis ikke noe slikt brett ble funnet, blir en tom liste returnert.
	 */
	public List<Integer> getHighScores(String levelName);
	
	/**
	 * Henter ut alle highscores for et gitt brett.
	 * @param level nummeret på brettet (første brett = 1, andre brett = 2 osv.)
	 * @return En liste i sortert rekkefølge over alle highscores fra det brettet. Hvis ikke noe slikt brett ble funnet, blir en tom liste returnert.
	 */
	public List<Integer> getHighScores(int level);
	
	/**
	 * Legger til en ny highscore til et brett.
	 * @param level brettet det er snakk om.
	 * @param score tiden i tidels sekunder
	 */
