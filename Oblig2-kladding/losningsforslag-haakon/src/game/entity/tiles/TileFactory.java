...
public class TileFactory {
	...
	public boolean registerTile(String name, boolean walkable, boolean lethal, int column, int row){
		if(names.contains(name)){
			return false;
		}
		names.add(name);
		this.lethal.put(name, lethal);
		this.walkable.put(name, walkable);
		this.column.put(name, column);
		this.row.put(name, row);
